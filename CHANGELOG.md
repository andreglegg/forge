...
- Revision-bound `SYMBOL <name>` inspection using a pinned TypeScript compiler parser for exact TypeScript/JavaScript declarations and named members, with text/native parity and deep-project end-to-end coverage.
...
- Static relationships do not yet resolve package imports, path aliases, or package exports; symbol lookup is syntax-only and semantic aliases, inferred types, locals, references, and callers remain planned.
